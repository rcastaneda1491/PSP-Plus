...
async function getProyecto() {
    const url = `https://172.30.236.13:8082/api/EditarProyecto?IdProyecto=${idProyecto}`;
...
async function editProyecto() {
    const url = `https://172.30.236.13:8082/api/ProyectoDesarrollador?idproyecto=${idProyecto}&nombre=${inputNombre.value}&descripcion=${inputDescripcion.value}&cliente=${inputCliente.value}&fechainicioesperada=${inputFechaInicioEsperada.value}&fechafinalesperada=${inputFechaFinalEsperada.value}&dev=${inputDev.value}`;
