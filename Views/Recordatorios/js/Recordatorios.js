...
async function GetDatos() {
    ...
    const url = `https://172.30.236.13:8082/api/Recordatorios?idUsuario=${jwt.sub}`;
...
async function actualizarEstado(e) {
  ...
  debugger;
    ...
    if(recordatoriovalor == "No Leído"){
        ...
        const url = `https://172.30.236.13:8082/api/Recordatorios?idRecordatorio=${recordatorioid}&estado=Leído`;
...
async function deleteRecordatorio(e) {
   ...
   /* const confirmar = confirm('¿Desea Eliminar Usuario?');
    if (confirmar) {
        ...
        const urlActualizarUsuario = `https://172.30.236.13:8082/api/Recordatorios?idRecordatorio=${recordatorioid}`;
